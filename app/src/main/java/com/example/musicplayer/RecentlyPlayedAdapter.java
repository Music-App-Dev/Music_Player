...
public class RecentlyPlayedAdapter extends RecyclerView.Adapter<RecentlyPlayedAdapter.MyHolder> {
    private final Context mContext;
    public static ArrayList<SpotifyTrack> recentTracks;
    View view;
    public RecentlyPlayedAdapter(Context mContext, ArrayList<SpotifyTrack> recentTracks){
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        SpotifyTrack track = recentTracks.get(position);
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putParcelableArrayListExtra("trackList", recentTracks);
